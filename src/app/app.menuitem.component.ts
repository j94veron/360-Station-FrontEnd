...
@Component({
    ...
    template: `
		<ng-container>
			<a (click)="itemClick($event)" *ngIf="authorizationService.isAuthorized(item.role)"  [ngClass]="item.class"
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public app: AppMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService, public authorizationService: AuthorizationService) {
